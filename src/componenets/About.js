...
export default function About() {
  return (
    ...
    <div className="mx-auto max-w-xl py-32 sm:py-2 lg:py-1">

      <div className="content-center">
        <img src={Image} className="rounded-full shadow-purple-900" alt="Jelena Rogic"></img>
        <p className="text-center mt-6 text-lg font-bold leading-8 text-gray-600 sm:text-2xl " >I'm a mom and a junior web developer.
      I was born and raised in Bosnia and Herzegovina and I ❤ to travel.
      My passion to travel the World brought me to Colorado where I currently live and work. Beside love for traveling and being mom I enjoy new challenges and problem solving which is exactly what pushed me in this great field of coding.</p>
      </div>
    </div>
